...
\newcommand{\fM}{f^{[M]}} % ensembled predictor
\newcommand{\fMx}{f^{[M]}(\xv)} % ensembled predictor
...
\newcommand{\fMw}{f_{\mathbf{w}}^{[M]}} % ensembled predictor weighted
\newcommand{\fMwx}{f_{\mathbf{w}}^{[M]}(\xv)} % ensembled predictor weighted
\newcommand{\fMwxi}{f_{\mathbf{w}}^{[M]}(\xv^{(i)})} % ensembled predictor weighted
