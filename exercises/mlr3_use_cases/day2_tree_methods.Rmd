...
lrns = list(
  lrn("classif.rpart", id = "rpart_md1", maxdepth = 1),
  lrn("classif.rpart", id = "rpart_md5", maxdepth = 5),
  lrn("classif.rpart", id = "rpart_md20", maxdepth = 20),
  lrn("classif.ranger", id = "rf_mtryr0.2", mtry.ratio = 0.2),
  lrn("classif.ranger", id = "rf_mtryr0.5", mtry.ratio = 0.5),
  lrn("classif.ranger", id = "rf_mtry0.8", mtry.ratio = 0.8))
