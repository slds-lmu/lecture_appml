...
Using the custom `loco()` function, we can compute and compare differences in insights gained from PFI and LOCO. For this purpose, we shall use the toy data from exercise 5. We fit a linear model on some training data:
