...
For this task, look at the iris data set. 
...
```{r, eval = show.solution}
oml_task = OMLTask$new(31)  # Task ID for OpenML dataset (iris dataset)
...
We downloaded various data sets from OpenML and used batch tools to parallelize the processes.
