...
Create a data.frame with the ground truth label, the predicted probabilities and predicted labels by both rpart and ranger.
...
You will need the total number of observations that are classified correctly by rpart only and those that are classified correctly by ranger only.
