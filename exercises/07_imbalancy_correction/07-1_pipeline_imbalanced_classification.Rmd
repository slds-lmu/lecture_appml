...
subtitle: "In-class exercise 07-1"
output:
...
<details>
  ...
  The new metric should **not** depend on the class distribution $P(Y = 1)$ (and $P(Y = 0) = 1 - P(Y = 1)$), i.e., we can equally weight the TPR and TNR to obtain a metric that does not take into account the class distribution. The resulting metric is known as the balanced
...
## Additional downsampling of the majority class
