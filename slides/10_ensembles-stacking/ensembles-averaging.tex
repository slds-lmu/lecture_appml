...
\begin{document}
\newcommand{\titlefigure}{slides/10_ensembles-stacking/figure/bagging.png}
...
\begin{columns}
    \begin{column}{0.6\textwidth}
        ...
        \begin{figure}
            \centering
            \includegraphics{slides/10_ensembles-stacking/figure/bagging.png}
            %\caption{Caption}
...
\begin{columns}
    \begin{column}{0.6\textwidth}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.7\textwidth]{slides/10_ensembles-stacking/figure/voting.png}
            %\caption{Caption}
            % from https://sebastianraschka.com/pdf/lecture-notes/stat479fs19/07_ensembles__notes.pdf
            \label{fig:voting}
        \end{figure}
