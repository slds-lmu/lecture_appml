...
\begin{itemize}
    ...
    $$
    T_{\text{t-test}} = \sqrt{8192 - 1} \; \frac{0.0016}{0.178} = 79.523
    $$
...
\end{align*}
\begin{itemize}
    \item For $\alpha = 0.05$ and $K = 6$, the critical difference in average ranks is 1.88.
...
\begin{itemize}
    ...
    \item For instance, the difference in mean ranks between ranger and SVM does not exceed the CD; the difference between ranger and rpart does exceed the CD. 
\end{itemize}
