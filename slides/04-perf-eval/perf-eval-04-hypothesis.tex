...
\begin{frame}{Wilcoxon Signed Rank Test}
    \begin{itemize}
        ...
        \item Consider $B$ data sets. Let $\widehat{\text{GE}}(\widehat{f}_k, \rho, \Dtestb)$  denote the GE estimate for model $k$ and data set $b$. The difference $d_b$ between GE estimates on the $b$-th data set is:
        $$
        d_b = \widehat{\text{GE}}(\widehat{f}_1, \rho, \Dtestb) - \widehat{\text{GE}}(\widehat{f}_2, \rho, \Dtestb)
        $$
