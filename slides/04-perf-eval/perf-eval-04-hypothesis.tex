...
\begin{frame}{Two-Matched-Samples T-Test}
\begin{itemize}
    \item Example: We evaluate learners \texttt{classif.rpart} and \texttt{classif.ranger} on the binary classification task \texttt{strikes}.
    \item We use the logarithmic (also known as cross-entropy) loss:
    {
        \scriptsize
        \include{slides/04-perf-eval/rsrc/conf.mat}
    }
\end{itemize}
