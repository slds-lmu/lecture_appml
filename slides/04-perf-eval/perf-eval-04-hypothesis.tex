...
\begin{frame}{Wilcoxon Signed Rank Test}
    \begin{itemize}
        \item A benchmark of 2 learners (with default hyperparameters) on 16 classification tasks, using the classification error as performance measure.
...
% \end{table}
$$
R^{+} = 14\qquad R^{-} = 1\qquad \min(R^{+}, R^{-}) = 1
$$
$$
