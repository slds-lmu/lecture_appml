...
\begin{itemize}
    ...
    {
        \scriptsize
        \include{slides/04-perf-eval/rsrc/rpart_ranger_kin8nm_task}
    }
...
\begin{frame}{Wilcoxon Signed Rank Test}
    \begin{itemize}
        ...
        $$
        \item Let $R^{+}$ denote the rank sum for data sets where algorithm 1 outperforms algorithm 2 and vice versa for $R^{-}$:
        $$
...
\end{itemize}
\includegraphics[width = 1.3\textwidth]{slides/04-perf-eval/figure/crit_diff_plot.png}
\end{frame}
