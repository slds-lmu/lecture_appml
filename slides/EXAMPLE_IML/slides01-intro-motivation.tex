...
%\bigskip
    ...
    \begin{column}{0.8\textwidth}
		...
		\end{itemize}
    \centering\includegraphics<2->[width=0.6\textwidth]{figure/performance_vs_interpretability.pdf}
...
\begin{frame}{Need for interpretability}
    ...
    \centering\includegraphics[width=0.95\textwidth]{figure/compass_black_white.PNG}
