...
\vspace{1em}
Popular method for post-hoc ensemble selection: Greedy ensemble selection (GES)
\begin{enumerate}
...
\end{enumerate}
\footnotesize Note that ensemble selection effectively optimizes the weights on an integer domain (i.e., base models are selected one or multiple times or not at all)
\end{vbframe}
