...
\begin{itemize}
\tightlist
  \item Model Governance includes the \textbf{people, processes, and technologies} needed to manage and protect your ML models.
...
\textbf{Monitoring} ensures that deployed models function reliably and alerts you to issues in production:
