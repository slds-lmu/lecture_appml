\documentclass[10pt,compress,t,notes=noshow, aspectratio=169, xcolor=table]{beamer}
...
\newcommand{\titlefigure}{figure_man/DSLifecycle1}
...
\lecturechapter{The Data Science Lifecycle}
...
\begin{frame}{The Data Science Lifecycle \citebutton{CRISP-DM}{https://en.wikipedia.org/wiki/Cross-industry_standard_process_for_data_mining}}
...
\begin{frame}{Datasheets \citebutton{Gebru et al., 2018}{https://arxiv.org/abs/1803.09010}}
...
\tiny Source: \href{https://www.kaggle.com/datasets/samithsachidanandan/netflix-stock-price-2002-2025}{Kaggle Datasets}
\end{figure}
...
\item Recommended tool: structured configuration managers
    \begin{itemize}
    \tightlist
      \item \textbf{Python}: \href{https://hydra.cc}{Hydra} - structured, hierarchical configuration management
      \item \textbf{R}: \href{https://cran.r-project.org/package=config}{config} - environment-based YAML setup
    \end{itemize}
\end{itemize}
\end{frame}
...
\tightlist
  ...
  \item \textbf{Bias Detection}: Reveal fairness issues and unintended discrimination
    \begin{itemize}
    \tightlist
      \item Example: Amazon's 2018 hiring tool penalized resumes with “women’s” due to biased training data \citebutton{The Guardian, 2018}{https://www.theguardian.com/technology/2018/oct/10/amazon-hiring-ai-gender-bias-recruiting-engine}
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{frame}{Model Cards  for
  Model Reporting \citebutton{Mitchell et al. 2019}{https://arxiv.org/pdf/1810.03993.pdf}}
...
"Developing and deploying ML systems is relatively fast and cheap, but
maintaining them over time is difficult and expensive."
\hfill~\href{https://papers.nips.cc/paper/5656-hidden-technical-debt-in-machine-learning-systems.pdf}{Hidden
Technical Debt in ML Systems}
\end{quote}
\end{frame}
...
\tightlist
  ...
  \item For frequent updates, establish model \textbf{versioning and lifecycle tracking}
    \begin{itemize}
    \tightlist
      \item Tools like \href{https://mlflow.org/}{MLflow} provide version control and a model registry
    \end{itemize}
\end{itemize}
\end{frame}
