...
\begin{frame}{Valid-Test Curves in Hyperparameter Optimization}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth,trim=0 0 540 0, clip]{slides/04_tuning/figure_man/figure_1.pdf}
        \includegraphics[width=0.7\linewidth,trim=540 0 0 0, clip]{slides/04_tuning/figure_man/figure_1.pdf}
    \end{figure}
...
\vfill
    \begin{figure}
        \centering
        \includegraphics[width=0.9\linewidth]{slides/04_tuning/figure_man/ecdf_all.pdf}
    \end{figure}
\vfill
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.99\linewidth]{slides/04_tuning/figure_man/normalized_test.pdf}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.99\linewidth]{slides/04_tuning/figure_man/biased_selection.png}
\end{figure}
\vfill
\end{frame}
