...
\includepdf[pages={2-9},trim=0 20 0 0,clip,width=490pt,offset=20pt 0pt,pagecommand={}]{i2ml/slides-tuning-intro.pdf}

\section{Hyperparameter Tuning Algorithms}

\includepdf[pages={2,4,6,7},trim=0 20 0 0,clip,width=490pt,offset=20pt 0pt,pagecommand={}]{i2ml/slides-tuning-basicalgos.pdf}
...
\includepdf[pages={2,4,5,10},trim=0 20 0 0,clip,width=490pt,offset=20pt 0pt,pagecommand={}]{i2ml/slides-tuning-advanced.pdf}
