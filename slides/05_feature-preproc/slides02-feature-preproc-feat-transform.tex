...
\item \textbf{Box-Cox Transformation:} Stabilizes variance, makes the data more normal distribution-like
    ...
    \end{array}\right.$$
    Note: Box-Cox can also be applied to the target -- see separate slide set.
\end{itemize}
...
\begin{itemize}
\item Transformations of the target variable can make modelling highly skewed data easier (see separate slide set on target transformations)
