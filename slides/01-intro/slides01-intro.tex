...
\subsection{Motivation and R6}
\includepdf[pages={7-8, 10-18}]{mlr3-intro.pdf}

\subsection{Data and Tasks}
\includepdf[pages={24, 26, 30-31}]{mlr3-intro.pdf}

\subsection{Dictionaries}
\includepdf[pages={33-36}]{mlr3-intro.pdf}

\subsection{Learner}
\includepdf[pages={39-40, 42, 44-50}]{mlr3-intro.pdf}

\subsection{Prediction and Evaluation}
\includepdf[pages={51-53, 55-59, 62-65, 67-71}]{mlr3-intro.pdf}
...
\includepdf[pages={3, 5, 8-9, 11, 13, 18-23, 27-31}]{mlr3-resampling.pdf}
...
\includepdf[pages={33-36, 40-41, 43}]{mlr3-resampling.pdf}

\section{Help and Summary}
\includepdf[pages={45-46, last}]{mlr3-resampling.pdf}
