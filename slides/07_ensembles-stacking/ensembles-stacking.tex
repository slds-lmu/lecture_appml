...
\begin{algorithm}[H]
    ...
    \BlankLine
    \textbf{Step 3: Train level 1 model $\fM$ on $\D^\prime$}\;\\
    \KwRet $\fM$\;
\end{algorithm}
...
\begin{itemize}
    \item One of the most popular and most successful AutoML systems \textit{AutoGluon} uses multilevel stacking together with repeated k-fold bagging https://auto.gluon.ai/stable/index.html
\end{itemize}
\end{vbframe}
